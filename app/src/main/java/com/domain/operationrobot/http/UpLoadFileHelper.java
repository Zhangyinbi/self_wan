package com.domain.operationrobot.http;

import android.text.TextUtils;
import com.domain.library.BaseApplicationController;
import com.domain.library.http.RxHelper;
import com.domain.library.http.TrustManager;
...
public class UpLoadFileHelper {
  ...
  public UpLoadFileHelper addInterceptor(Interceptor interceptor) {
    interceptors.add(interceptor);
    return this;
  }

  public UpLoadFileHelper initUrl(String baseUrl) {
